...
public class prueba {
	...
	public static void main(String[] args) {
		...
		// Enter email address
		driver.findElement(By.cssSelector("[name='email_create']")).sendKeys("xespitia@hotmail.com");
		...
		WebElement inputele = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("customer_firstname")));

		driver.findElement(By.xpath("//input[@id=\"id_gender1\"]")).click();
		inputele.sendKeys("Test User");
